...
# DEFESA GLOBAL CONTRA NAMEERROR
...
# ==========================================================
    ...
    with st.container(border=True):
        ...
        with col_cal_b2: data_b_fim = st.date_input("Período B - Fim", value=date.today() - relativedelta(days=15), format="DD/MM/YYYY")
    ...
    usar_grafico_barras = (dias_per_a > 28 and dias_per_b > 28)
    titulo_grafico_tempo = "Performance Histórica Mensal" if usar_grafico_barras else "Faturamento Diário Comercial"
            ...
            for _, row in df_matriz_macro.iterrows():
                ...
                if esta_expandido:
                    ...
                    for _, sub_row in df_matriz_sub.iterrows():
                        ...
                        local_index = inline_index = linha_filha.index
